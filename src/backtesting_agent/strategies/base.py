...
if TYPE_CHECKING:  # pragma: no cover -- typing only
    ...
    from backtesting_agent.config.schema import EventGateConfig
    from backtesting_agent.event_gate import AppliedGate
...
class StrategyBase(Strategy):
    ...
    def parameter_space(cls) -> dict[str, dict[str, Any]]:
        ...
        :func:`backtesting_agent.indicators.base.suggest_params`.
    ...
    def _apply_event_gate(
        ...
        from backtesting_agent.event_gate import apply_gate_at_decision
